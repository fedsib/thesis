...
\begin{longtabu} to \textwidth {cXXc}
    ...
    %\hline
    \textbf{ID} & \textbf{Descrizione} & \textbf{Comportamento atteso} & \textbf{Stato}\\
    TF005 & \gls{build} di applicazioni web Maven & L'applicazione di esempio genera un file ``.\gls{war}'' & Riuscito\\ %\hline
    ...
    TF007 & Esecuzione di \gls{build} distribuite con più \gls{host} & Le \gls{build} vengono eseguite correttamente su entrambi i nodi \gls{host} & Riuscito\\ %\hline
